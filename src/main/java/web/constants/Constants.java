...
public class Constants {
    ...
    public static final String HOME_URL = "https://xistore.by";
    ...
    public static final String LOGIN = "ppp694185@gmail.com";
    public static final String PASSWORD = "10293847ppp";
